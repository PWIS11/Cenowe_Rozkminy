...
danych z określonymi regułami logicznymi i jakościowymi, aby upewnić
się, że dane są kompletne, spójne <br>i gotowe do dalszej analizy oraz
modelowania.
...
zwraca się na typy danych i analizę unikalnych wartości w poszczególnych
kolumnach. Każda kolumna powinna mieć odpowiedni typ danych (np.
numeryczny, tekstowy, całkowity), a liczba unikalnych wartości powinna
być zgodna <br> z oczekiwaniami.
...
zmiennych tekstowych (typ character)**, **3 zmiennymi kategorycznymi
...
-   Zmienne **numeryczne**, takie jak `square_meters`, `price` czy
    `centre_distance`, mają dużą liczbę unikalnych wartości, <br> co
...
czy tworzenie nowych zmiennych, <br>w zależności od typu danych i celu
analizy.
...
knitr::kable(korelacje_cena_odl, col.names = c("Miasto", "Wynik korelacji"), caption = "Współczynniki korelacji między odległością od szkół a ceną mieszkań")
```
...
#   
#   "Warszawa" <- c("Słaba, ujemna", "Słaba, ujemna", "Słaba, ujemna", "Słaba, ujemna", "Słaba, dodatnia", "Słaba, ujemna", ),
#   "Kraków" <- c("Silna, ujemna", "Silna, ujemna", "Słaba, ujemna", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, ujemna", ),
#   "Białystok" <- c("Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", ),
#   "Rzeszów" <- c("Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", ),
#   "Częstochowa" <- c("Słaba, dodatnia", "Słaba, ujemna", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, ujemna", ),
#   "Radom" <- c("Słaba, ujemna", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", "Słaba, dodatnia", )
#   
# )

#SKONCZONE NA RESTAURACJACH
