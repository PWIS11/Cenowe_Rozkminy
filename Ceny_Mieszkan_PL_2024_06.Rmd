...
Każde miasto posiada swoje charakterystyczne „gałęzie” reprezentujące
...
ggraph(graph, layout = "dendrogram") +
  geom_edge_diagonal() +
  geom_node_point(size = 14, color = "plum") +
  geom_node_text(aes(label = name), vjust = 0.44, size=8) +
  theme_void()

#zmienne do uwzględnienia
#Kraków – winda, parking, balkon, ochrona, komórka
#Warszawa: winda, parking, balkon, ochrona, komórka
#Rzeszów: winda, parking, komórka
#Radom: parking
#Białystok: balkon, winda
#Częstochowa: balkon, parking
