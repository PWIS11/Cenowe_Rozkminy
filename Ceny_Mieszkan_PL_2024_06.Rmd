...
chi_results <- data.frame(
  ...
  ChiSq_Statistic = c(
    chisq.test(chi_tabela1)$statistic,
    chisq.test(chi_tabela2)$statistic,
    chisq.test(chi_tabela3)$statistic,
    chisq.test(chi_tabela4)$statistic,
    chisq.test(chi_tabela5)$statistic,
    chisq.test(chi_tabela6)$statistic,
    chisq.test(chi_tabela7)$statistic,
    chisq.test(chi_tabela8)$statistic,
    chisq.test(chi_tabela9)$statistic,
    chisq.test(chi_tabela10)$statistic
  ),
  p_value = formatC(c(
