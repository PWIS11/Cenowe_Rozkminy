...
# Największe braki w: kondycji, materiale budowniczym, typie, podłodze, wieku nieruchomości, posiadniu windy, odległości do uczelni; 
# reszta braków <1%
missing_df <- missing_df %>%
arrange(desc(missing_percent))
braki_procentowe_w_obserwacjach_df <- missing_df
