...
kondygnacji po modernizacji). Aby poprawić te błędy, przyjęto zasadę, że w takich
sytuacjach wartość liczby kondygnacji (floor_count) zostanie ustawiona
na wartość piętra (floor). Jeśli wartość liczby kondygnacji była równa lub większa od wartości
