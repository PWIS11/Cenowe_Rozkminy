...
|                | (p=0.0294) i winda | cena/m² × parking  |
|                | (p=0.0259)         | (p=0.000883) jest  |
|                | znacząco podnoszą  | istotna – wpływ    |
|                | cenę\              | ceny/m² na cenę    |
|                | - Parking          | zależy od          |
|                | (p=0.4013) nie ma  | obecności parkingu |
|                | istotnego wpływu   |                    |
+----------------+--------------------+--------------------+
| -   \*C        | \- Balkon          | \- Interakcja      |
|                | (p=0.01198) i      | cena/m² × parking  |
| zęstochowa\*\* | parking            | (p=0.01881) jest   |
|                | (p=0.00117)        | istotna            |
|                | istotnie podnoszą  |                    |
|                | cenę               |                    |
+----------------+--------------------+--------------------+
...
|                | bardzo silny wpływ | (p=0.269)          |
|                | na cenę            | nieistotna         |
+----------------+--------------------+--------------------+
| **Kraków**     | \- Balkon          | \- Istotne         |
|                | (p\<2e-16), winda  | interakcje z windą |
|                | (p=1.37e-05) i     | (p=0.0127) i       |
|                | parking            | pomieszczeniem     |
|                | (p=3.60e-07) mocno | gosp. (p=0.0261) – |
|                | wpływają na cenę\  | wpływ ceny/m²      |
|                | - Ochrona          | różni się w        |
|                | (p=0.8549) nie ma  | zależności od      |
|                | wpływu\            | obecności tych     |
|                | - Pomieszczenie    | udogodnień         |
|                | gospodarcze        |                    |
|                | (p=0.0597) – efekt |                    |
|                | graniczny          |                    |
+----------------+--------------------+--------------------+
