...
kompletne, spójne i gotowe do dalszej analizy oraz modelowania.

</p>

## **Czym jest walidacja danych ?**

Walidacja danych to proces, którego celem jest weryfikacja, czy dane spełniają 
określone kryteria, zapewniając ich poprawność, spójność oraz integralność.
Jednym z kluczowych elementów tego procesu jest weryfikacja typów danych 
oraz analiza unikalnych wartości w poszczególnych kolumnach. Ważne jest,
aby każda kolumna miała odpowiedni typ danych (np. numeryczny, tekstowy,całkowity),
a liczba unikalnych wartości była zgodna z oczekiwaniami. Taka analiza pozwala 
wykryć potencjalne błędy w strukturze danych, jak niewłaściwe przypisanie typu 
do kolumny czy nieoczekiwane wartości. Dzięki temu mamy pewność, że dane 
są odpowiednio przygotowane do dalszej analizy i modelowania.
...
logicznych, które zapewniają spójność danych. W projekcie zastosowano następujące
reguły walidacyjne:
...
4. Piętro (Floor) i liczba kondygnacji (Floor Count) muszą być większe lub równe 
0.
