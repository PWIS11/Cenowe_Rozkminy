...
edges <- data.frame(
  from = c("Miasta", "Miasta", "Miasta", "Kraków", "Kraków", "Kraków", "Radom", "Radom", "Radom", "Rzeszów", "Rzeszów", "Rzeszów"),
  to   = c("Kraków", "Radom", "Rzeszów", "Winda", "Balkon", "Parking", "Balkon", "Winda", "Komórka", "Balkon", "Winda", "Komórka")
)
...
ggraph(graph, layout = "dendrogram") +
  geom_edge_diagonal() +
  geom_node_point(size = 9, color = "plum") +
